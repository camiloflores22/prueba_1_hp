...
namespace prueba_1_hp.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,NombreEstudiante,ApellidoEstudiante,RutEstudiante,DireccionEstudiante,Edad,Email,FechaNacimiento")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,NombreEstudiante,ApellidoEstudiante,RutEstudiante,DireccionEstudiante,Edad,Email,FechaNacimiento")] Estudiante estudiante)
        {
